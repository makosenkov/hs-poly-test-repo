...
prop_isDateCorrect year =
    False === isDateCorrect 30 02 year
        ...
        .&&. True === isDateCorrect 31 07 year -- исправлено
...
unit_triangleKind =
    do
        ...
        triangleKind 5.0 3.0 4.0 @?= 2 -- исправлено
        triangleKind 4.0 6.0 8.0 @?= 0 -- исправлено
        triangleKind 1.0 1.5 1.5 @?= 1 -- исправлено
